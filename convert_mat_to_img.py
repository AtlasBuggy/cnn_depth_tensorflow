...
def convert_nyu(path):
    ...
    for i, (image, depth) in enumerate(zip(f['images'], f['depths'])):
        ...
        image_name = os.path.join("data", "nyu_datasets_v1", "%05d.jpg" % (i))
        image_pil.save(image_name)
        depth_name = os.path.join("data", "nyu_datasets_v1", "%05d.png" % (i))
    ...
    with open('train_v1.csv', 'w') as output:
...
if __name__ == '__main__':
    ...
    nyu_path = 'data/nyu_depth_data_labeled.mat'
